...
// import { GoogleGenAI } from "@google/genai" // IA SUPPRIMÉE
...
export default function SiteInspector() {
  ...
  // NOUVEL ETAT POUR LE 3EME IFRAME
  ...
  const detectAnimationLibrary = (
    ...
    // ... (La logique de détection reste la même)
  ...
  const analyzeSite = async (urlToAnalyze = url) => {
    ...
    setShowReducedPreviewFrame(false) // Réinitialiser le 3ème iframe
    setCopyStatus(null)
    try {
      // ... (La logique d'analyse du site reste la même)
  ...
  const gen = (fw: FrameworkKey) => {
    // ... (La logique de génération de code pour les frameworks reste la même)
  ...
  // NOUVELLE FONCTION POUR CONSTRUIRE UNIQUEMENT LE PROMPT RÉDUIT
  ...
  // NOUVELLE FONCTION POUR TÉLÉCHARGER LE PROMPT RÉDUIT
  ...
  const HeaderAction = () => {
    // ... (Logique d'affichage de l'utilisateur reste la même)
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden p-4 sm:p-8">
      ...
      <div className="max-w-4xl mx-auto p-6 sm:p-10 pb-40"> {/* Augmentation du padding bottom */}
        ...
        {result && (
          <div className="space-y-12">
            ...
            {/* LE TROISIÈME IFRAME APPARAÎT ICI */}
          ...
          <div className="flex items-center gap-4 bg-white/80 backdrop-blur-lg p-2 rounded-2xl shadow-2xl border">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Button onClick={() => setShowReducedPreviewFrame(true)} className="bg-purple-600 hover:bg-purple-700 text-white">
               ...
               {/* NOUVEAU BOUTON "TÉLÉCHARGER PROMPT RÉDUIT" */}
      ...
      <Dialog open={showExportModal} onOpenChange={setShowExportModal}>
          {/* ... (Le contenu du modal d'exportation reste le même) */}
